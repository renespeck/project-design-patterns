...
# Note que não é necessário instanciar a classe externa A, mesmo quando nós criamos uma instância da classe interna.
...
# Esta seção revê o conceito de classe derivada. As classes derivadas são uma característica extremamente útil em Python 
